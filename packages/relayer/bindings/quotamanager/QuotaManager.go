...
//
// Solidity: function init(address _owner, address _sharedAddressManager, uint24 _quotaPeriod) returns()
func (_QuotaManager *QuotaManagerTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sharedAddressManager common.Address, _quotaPeriod *big.Int) (*types.Transaction, error) {
	return _QuotaManager.contract.Transact(opts, "init", _owner, _sharedAddressManager, _quotaPeriod)
}

// Init is a paid mutator transaction binding the contract method 0x28b94164.
//
// Solidity: function init(address _owner, address _sharedAddressManager, uint24 _quotaPeriod) returns()
func (_QuotaManager *QuotaManagerSession) Init(_owner common.Address, _sharedAddressManager common.Address, _quotaPeriod *big.Int) (*types.Transaction, error) {
	return _QuotaManager.Contract.Init(&_QuotaManager.TransactOpts, _owner, _sharedAddressManager, _quotaPeriod)
}

// Init is a paid mutator transaction binding the contract method 0x28b94164.
//
// Solidity: function init(address _owner, address _sharedAddressManager, uint24 _quotaPeriod) returns()
func (_QuotaManager *QuotaManagerTransactorSession) Init(_owner common.Address, _sharedAddressManager common.Address, _quotaPeriod *big.Int) (*types.Transaction, error) {
	return _QuotaManager.Contract.Init(&_QuotaManager.TransactOpts, _owner, _sharedAddressManager, _quotaPeriod)
}
