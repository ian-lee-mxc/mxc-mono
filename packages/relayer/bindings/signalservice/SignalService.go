...
// Init2 is a paid mutator transaction binding the contract method 0xba232ddc.
//
// Solidity: function init2(address _owner, address _sharedAddressManager) returns()
func (_SignalService *SignalServiceTransactor) Init2(opts *bind.TransactOpts, _owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _SignalService.contract.Transact(opts, "init2", _owner, _sharedAddressManager)
}

// Init2 is a paid mutator transaction binding the contract method 0xba232ddc.
//
// Solidity: function init2(address _owner, address _sharedAddressManager) returns()
func (_SignalService *SignalServiceSession) Init2(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _SignalService.Contract.Init2(&_SignalService.TransactOpts, _owner, _sharedAddressManager)
}

// Init2 is a paid mutator transaction binding the contract method 0xba232ddc.
//
// Solidity: function init2(address _owner, address _sharedAddressManager) returns()
func (_SignalService *SignalServiceTransactorSession) Init2(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _SignalService.Contract.Init2(&_SignalService.TransactOpts, _owner, _sharedAddressManager)
}
