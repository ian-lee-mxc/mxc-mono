...
//
// Solidity: function sendToken((uint64,address,address,uint64,address,uint32,uint256[],uint256[]) _op) payable returns((uint64,uint128,uint32,address,uint64,address,uint64,address,address,uint256,bytes) message_)
