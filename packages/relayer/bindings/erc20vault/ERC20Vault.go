...
// OnMessageRecalled is a paid mutator transaction binding the contract method 0x12bc6a4a.
//
// Solidity: function onMessageRecalled((uint64,uint128,uint32,address,uint64,address,uint64,address,address,uint256,bytes) _message, bytes32 _msgHash) payable returns()
...
// SendToken is a paid mutator transaction binding the contract method 0xb1acf88e.
//
// Solidity: function sendToken((uint64,address,address,uint128,address,uint32,uint256) _op) payable returns((uint64,uint128,uint32,address,uint64,address,uint64,address,address,uint256,bytes) message_)
