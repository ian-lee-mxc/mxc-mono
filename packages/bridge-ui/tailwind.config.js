    ...
    themes: [
      {
        dark: {
          ...
          '--primary-link': '#bae6fd', // pink-200
          '--primary-link-hover': '#eff6ff', // pink-50
          '--primary-icon': '#CACBCE', // grey-100
          '--primary-background': '#0B101B', // grey-900
          '--primary-interactive': '#0ea5e9', // pink-500
          '--primary-interactive-accent': '#38bdf8', // pink-400
          '--primary-interactive-hover': '#38bdf8', // pink-400
          '--primary-border-hover': '#bae6fd', // pink-200

          '--primary-border-dark': '#5D636F', // grey-500
          '--primary-border-accent': '#38bdf8', // pink-400
          '--primary-base-background': '#FFFFFF', // grey-0
          '--primary-base-content': '#191E28', // grey-800

          '--secondary-brand': '#38bdf8', // pink-400
          ...
          primary: '#0ea5e9', // pink-500,
          'primary-focus': '#38bdf8', // pink-400
          'primary-content': '#F3F3F3', // grey-10

          secondary: '#38bdf8', // pink-400
          // 'secondary-focus': '',
          'secondary-content': '#ADB1B8', // grey-200
        ...
        light: {
          ...
          '--primary-brand': '#0ea5e9', // pink-500
          '--primary-content': '#191E28', // grey-800
          '--primary-link': '#0ea5e9', // pink-500
          '--primary-link-hover': '#38bdf8', // pink-400
